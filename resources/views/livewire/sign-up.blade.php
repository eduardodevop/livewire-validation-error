<div class="p-5 container m-5 rounded border bg-light">
    ...
    <form method="post" action="#" wire:submit.prevent="createUser()">
        <div class="my-2">
            ...
            <input type="text" maxlength="150" placeholder="Name" class="form-control" wire:model.defer="name">
            @error('name') <span class="text-danger">{{ $message }}</span> @enderror
        </div>

        <div class="my-2">
            <label for="description">Email</label>
            <input type="email" maxlength="150" placeholder="Email" class="form-control" wire:model.defer="email">
